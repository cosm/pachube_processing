...
*/
	...
	public String eemlPOST(String postURL, String pachubeAPIKey){		
		String response = "";
		try {
		response = postDataAuthorize(postURL,"eeml="+java.net.URLEncoder.encode(createEEML(), "UTF-8"), pachubeAPIKey);
		}
		catch (Exception e)
		{
	...
	@param parameters the parameters in unencoded-url format (param1=value&param2=value etc.)
	@return the response generated by the url from the post
	 */
	public static String postDataAuthorize(String urlstr, String parameters, String pachubeAPIKey)
	throws IOException
	{
		...
		try{
			...
			hpcon.setRequestProperty ("X-PachubeApiKey", pachubeAPIKey);//"Basic " + encoding);        
			...
			System.out.println("There was a problem while POSTing: " + e);
